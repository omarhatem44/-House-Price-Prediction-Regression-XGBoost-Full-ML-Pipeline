...
This project implements an end-to-end machine learning pipeline to predict housing prices using the popular **House Prices – Advanced Regression Techniques** dataset.  
